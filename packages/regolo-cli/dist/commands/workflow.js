...
export default class Workflow extends BaseCommand {
    ...
    static description = 'Complete workflow: register model, upload (if custom), and optionally load for inference';
    static examples = [
    ...
    async run() {
        ...
        this.log(`  Type:  ${type}`);
        if (autoLoad)
            this.log('  Status: Loading for inference...');
    }
}
